    ...
    <form method="post" action="<?php echo base_url('empresa/atualizar_dados') ?>">
        <div class="container">   
            <div class="row">
                ...
                <div id="myAffix" style="position: fixed; bottom: 40%; display: block; width: 10%; right: 24%;" data-spy="affix" data-offset-bottom="230" > <!--data-spy="affix" data-offset-top="197"-->
