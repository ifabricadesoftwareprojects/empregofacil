...
class Experiencia_model extends MY_Model {
    ...
    public function validar_dados() {
        ...
        $mes_ano_termino = explode("/", $this->mes_ano_termino);
        $mes1 = $mes_ano_termino[0];
        $ano1 = $mes_ano_termino[1];
        $CI = & get_instance();
        ...
        if ($this->mes_ano_termino != '') {
            $validate->set('mes_ano_termino', $mes1)->between_values(1, 12)
                    ->set('mes_ano_termino', $ano1)->max_value(date("Y") + 1);
        }
